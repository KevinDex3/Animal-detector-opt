...
MODEL_PATH = os.path.join(SCRIPT_DIR, "mobilenet_v2.pth")
...
def handle(event, context):
    try:
        #Controlla se il file del modello esiste sul disco, cioè se mobilenet_v2.pth è presente nel percorso indicato da MODEL_PATH.
